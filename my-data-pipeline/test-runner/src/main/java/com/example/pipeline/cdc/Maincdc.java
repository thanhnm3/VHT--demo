...
//         Dotenv dotenv = Dotenv.configure().directory("my-data-pipeline/.env").load();
...
//             CdcConsumer.main(new String[]{}, consumerThreadPoolSize, maxMessagesPerSecond, consumerHost, consumerPort, consumerNamespace, consumerHost, consumerPort, kafkaBroker);
//         });
